...
<html>
    <head>
        ...
        <title>Track Cert - Admin Forgot Password OTP</title>
        <style>
            ...
            <table align="center" cellpadding="0" cellspacing="0" width="600" style="background: #ffffff;font-family:Calibri, sans-serif; margin: 0 auto; background-size: 100%; padding: 10px 30px 0px 30px;">
                ...
                <tr>
                    <td style=" padding: 10px;" bgcolor="#ffffff">
                        <h1 style="font-size: 16px;font-weight: 600;line-height: 24px;text-align:justify;color: #767171; margin: 0; padding:0; text-transform: capitalize;">HELLO, {{ $customer_name ?? "Track Cert" }}!</h1>
                    </td>
                </tr>
                <tr>
                    <td valign="top" style="padding:0 10px;">
                        <p style="font-size: 14px;font-weight: normal;line-height: 24px;text-align:justify;color: #767171; margin: 0; padding:0">We have received your request for changing the password please find the OTP below. If you have not initiated this request please contact <a href="mailto:trackcert@gmail.com">trackcert@gmail.com</a> for the same.</p>
                    </td>
                </tr>
                <tr>
                    <td valign="top" style="padding:0 10px;">
